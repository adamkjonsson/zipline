...
- unknown block type → skip via frame `length` ([zipline-payload-format.md:716-719](zipline-payload-format.md#L716-L719))
- unknown option id → skip via `len`, but **retain every occurrence in file order** ([zipline-payload-format.md:1094-1098](zipline-payload-format.md#L1094-L1098))
- reserved fields/bits → ignore on read ([zipline-payload-format.md:699-700](zipline-payload-format.md#L699-L700))
- none of these is an error ([zipline-payload-format.md:1385-1387](zipline-payload-format.md#L1385-L1387))

The JSONL face is defined as "**one rule plus a short list of exceptions**"
([zipline-payload-format.md:1411-1426](zipline-payload-format.md#L1411-L1426)) — but that rule
...
([zipline-payload-format.md:1492-1497](zipline-payload-format.md#L1492-L1497)). There is no
...
**Valid.** [zipline-payload-format.md:1428-1442](zipline-payload-format.md#L1428-L1442) maps
eleven block types to `type` strings. [zipline-payload-format.md:1495-1496](zipline-payload-format.md#L1495-L1496)
...
skip ([zipline-payload-format.md:739-741](zipline-payload-format.md#L739-L741)). Today that
...
([zipline-payload-format.md:95-96](zipline-payload-format.md#L95-L96)), and a
...
[zipline-payload-format.md:1379-1380](zipline-payload-format.md#L1379-L1380)). Adding a
...
([zipline-payload-format.md:1477](zipline-payload-format.md#L1477)) gives it nowhere to go, so
it vanishes.
...
([zipline-payload-format.md:1094-1098](zipline-payload-format.md#L1094-L1098)). A hex-token
...
1. It classifies the whole file as raw vs derived ([zipline-payload-format.md:1278-1281](zipline-payload-format.md#L1278-L1281)).
2. It tells a decoder-less record apart as raw vs pass-through ([zipline-payload-format.md:1286-1288](zipline-payload-format.md#L1286-L1288)).
3. **It selects how `spans` offsets are interpreted** — logical stream offsets for
   ...
   ([zipline-payload-format.md:1158-1163](zipline-payload-format.md#L1158-L1163)).
...
the error-handling tiers ([zipline-payload-format.md:1364-1377](zipline-payload-format.md#L1364-L1377)),
...
`tick_hz` is a u64 ([zipline-payload-format.md:730](zipline-payload-format.md#L730)); the alias
table maps JSONL `time_units` → `tick_hz` ([zipline-payload-format.md:1450](zipline-payload-format.md#L1450));
and value encoding says a 64-bit field is a JSON number or a **decimal string**
([zipline-payload-format.md:1461-1466](zipline-payload-format.md#L1461-L1466)). Under that
rule `"us"` is illegal. Yet all six JSONL examples write `"time_units":"us"`
(lines 180, 346, 422, 648, …).

Normative text wins over examples ([zipline-payload-format.md:673-674](zipline-payload-format.md#L673-L674)),
...
1. *"a zpf-file can only be marked as sequenced"* — sequencing is **per session**,
   not per file, and deliberately so ([zipline-payload-format.md:373-385](zipline-payload-format.md#L373-L385)).
2. *"…if their time stamps are increasing"* — v1.0 imposes the timestamp/clock
   ...
   trustworthy clock" ([zipline-payload-format.md:447-456](zipline-payload-format.md#L447-L456),
   restated at [zipline-payload-format.md:1332-1334](zipline-payload-format.md#L1332-L1334)).
...
3. *"Look for a mechanism that allows records to be stored logically sequenced
   ...
   example. [zipline-payload-format.md:340-368](zipline-payload-format.md#L340-L368) shows the
   server record at `ts:995` answering a client request at `ts:1000`, and
   [zipline-payload-format.md:421-438](zipline-payload-format.md#L421-L438) shows the merged
...
([zipline-payload-format.md:1003](zipline-payload-format.md#L1003), `e.g.`), so `skipped` is
...
Undecoded block ([zipline-payload-format.md:1302-1307](zipline-payload-format.md#L1302-L1307)).
...
([zipline-payload-format.md:1006-1013](zipline-payload-format.md#L1006-L1013)):
...
([zipline-payload-format.md:1308-1318](zipline-payload-format.md#L1308-L1318)). To the issue's
...
time ([zipline-payload-format.md:1010-1017](zipline-payload-format.md#L1010-L1017)), and the
`digest` is a Makefile-style dependency edge, not a copy
([zipline-payload-format.md:572-574](zipline-payload-format.md#L572-L574)). So: the first
...
([zipline-payload-format.md:1278-1285](zipline-payload-format.md#L1278-L1285)). An annotated
copy of a decoded file fits neither:

- it cannot be a **pass-through**, because pass-through records carry no
  `decoder_id` ([zipline-payload-format.md:1308](zipline-payload-format.md#L1308)) while its
  ...
  ([zipline-payload-format.md:788](zipline-payload-format.md#L788), [zipline-payload-format.md:980](zipline-payload-format.md#L980))
...
([zipline-payload-format.md:1119](zipline-payload-format.md#L1119)). Using it as a
...
for vendor/experimental data, [zipline-payload-format.md:1050-1059](zipline-payload-format.md#L1050-L1059))
...
- An **N = 1 session** (one-way UDP/multicast feed, [zipline-payload-format.md:87](zipline-payload-format.md#L87))
  has no cross-participant order to resolve at all, and its per-participant order
  is *already* a normative MUST ([zipline-payload-format.md:1250-1257](zipline-payload-format.md#L1250-L1257)).
...
Conformance section ([zipline-payload-format.md:1320-1339](zipline-payload-format.md#L1320-L1339))
...
MAY reject the file ([zipline-payload-format.md:1263-1265](zipline-payload-format.md#L1263-L1265)).
...
([zipline-payload-format.md:421-438](zipline-payload-format.md#L421-L438)) would be rejected
by such a reader.
...
([zipline-payload-format.md:1265-1267](zipline-payload-format.md#L1265-L1267)). The obligation
...
- File flags: "reserved, MUST be written 0, and MUST be ignored on read" ([zipline-payload-format.md:761-762](zipline-payload-format.md#L761-L762))
- Session flags: same ([zipline-payload-format.md:814-815](zipline-payload-format.md#L814-L815))
- Record flags: "reserved, MUST be 0" ([zipline-payload-format.md:1201](zipline-payload-format.md#L1201))

The global rule at [zipline-payload-format.md:699-700](zipline-payload-format.md#L699-L700)
...
1. **The logical offset space of a *decoded* file is never defined.** Offsets are
   ...
   the first reassembled byte ([zipline-payload-format.md:514-526](zipline-payload-format.md#L514-L526))
   ...
   ([zipline-payload-format.md:502-504](zipline-payload-format.md#L502-L504)) and requires the
...
semantic-violation tier ([zipline-payload-format.md:1364-1377](zipline-payload-format.md#L1364-L1377))
...
[zipline-payload-format.md:421-438](zipline-payload-format.md#L421-L438), noting that the
...
- [x] Fixed **65 broken relative links in this document** — they were written
      root-relative (`docs/zipline-payload-format.md`, `README.md`) but this file lives
...
- [x] **#15** — renamed to `zipline-payload-format.md` (kebab-case, no version in
      the name) in its own commit, last, via `git mv` so the history follows.
      124 references updated across [README.md](../README.md),
      [CHANGELOG.md](../CHANGELOG.md), [CLAUDE.md](../CLAUDE.md) and this
      document; every link in all five markdown files verified to resolve
...
- [ ] The two standing *Open questions*
      ([zipline-payload-format.md:1603-1608](zipline-payload-format.md#L1603-L1608)) —
